...
export const SEND_SMS_URL =
  SMS_API +
  '?username=' +
  SMS_CREDENTIALS.USERNAME +
  '&password=' +
  SMS_CREDENTIALS.PASSWORD +
  '&from=' +
...
export const HUTCH_CLIENT_ID = process.env.HUTCH_CLIENT_ID;
export const HUTCH_CLIENT_SECRET = process.env.HUTCH_CLIENT_SECRET;
export const HUTCH_CLIENT_USERNAME = process.env.HUTCH_CLIENT_USERNAME;
export const HUTCH_CLIENT_PASSWORD = process.env.HUTCH_CLIENT_PASSWORD;
export const HUTCH_TOKEN_URL = process.env.HUTCH_TOKEN_URL;
export const HUTCH_BUNDLE_ID = process.env.HUTCH_BUNDLE_ID;
export const HUTCH_OTP_URL = process.env.HUTCH_OTP_URL;
export const HUTCH_OTP_VERIFY_URL = process.env.HUTCH_OTP_VERIFY_URL;
export const HUTCH_OTP_UNREGISTER_URL = process.env.HUTCH_OTP_UNREGISTER_URL;

export const getPaymentURL = (mobile: string) => {
  return `${process.env.IDEABIZ_PAYMENT_URL}tel:${mobileGenerator(
    mobile,
  )}/transactions/amount`;
};
